...
function row(code, statut, extra = {}) {
...
function recv(code, monthsAgo, addMo, taille = "M") {
...
function renewOverdue(code, monthsAgo, weeksAgo, taille = "M") {
    const issued = subMonths(monthsAgo);
...
function renewNextDaysAgo(code, issueMonthsAgo, daysAgo, taille = "M") {
...
function renewNextMonthsAgo(code, issueMonthsAgo, nextWasMonthsAgo, taille = "M") {
    const issued = subMonths(issueMonthsAgo);
...
function repl(code, monthsAgo, taille = "M") {
    const issued = subMonths(monthsAgo);
...
export const EPI_PRESEED_REPLACEMENT_REQUESTS = [
...
export const EPI_SEED_EMPLOYEES = [
    {
